...
export default () =>
    <div id="quemsomos">
        <h1>Quem Somos</h1>
        <p className='pt-3'>A Delegacia Sindical de Goiânia (DS/Goiânia) compõe a estrutura do Sindifisco Nacional, Sindicato dos Auditores Fiscais da Receita Federal do Brasil.</p>
        <p>Sua missão é defender as prerrogativas necessárias para que o Auditor-Fiscal possa desempenhar sua função de:</p>
        <ol>
            <li>controlar a entrada e saída de bens e mercadorias do país;</li>
            <li>verificar o cumprimento das obrigações tributárias principais e acessórias;</li>
            <li>selecionar contribuintes com base em critérios objetivos e impessoais;</li>
            <li>lançar, garantir, controlar e cobrar o crédito tributário;</li>
            <li>restituir tributo pago a maior;</li>
            <li>ressarcir tributo cuja legislação exija antecipação de pagamento e sua apuração resultou em crédito devido ao contribuinte; e</li>
            <li>julgar processos administrativos fiscais.</li>
        </ol>
        <p>No contexto em que o governante de plantão decide pesar a tributação sobre os mais carentes, e conceder benefícios fiscais aos mais abastados, torna-se necessário defender com maior força a prerrogativa do Auditor-Fiscal.</p>
        <p className='pb-5'>Ao agir desta forma, o Sindicato defende a instituição Receita Federal, a concorrência salutar e o interesse público!</p>
        <h1>Diretoria Executiva - Triênio 2022 a 2024</h1>
        ...
        <p>Diretor de Assuntos de Aposentadoria, Proventos e Pensões – NELIA CRUVINEL RESENDE</p>
        <p>Diretor de Assuntos Jurídicos – RICARDO SKAF ABDALA</p>
        <p>Diretor de Defesa da Justiça Fiscal, da Seguridade Social e Defesa Profissional – DIVINO DEONIR DIAS BORGES</p>
        <p> Diretor de Comunicação Social e Assuntos Parlamentares – GILENIR DO ROSARIO SILVA</p>
